 ...
 */
package com.graypn.swiperefreshlayout.demo.view;
 ...
 */
public class SingleBounce extends View {

    private static final String TAG = SingleBounce.class.getSimpleName();
    /**
    ...
    public SingleBounce(Context context) {
        this(context, null, 0);
    }

    public SingleBounce(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SingleBounce(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (bouncer == null || !bouncer.isRunning()) {
            ...
            bouncer.playTogether(firstAnimator);
            bouncer.start();
        }
    }
    ...
    private ObjectAnimator initDrawableAnimator(Property<SingleBounce, Integer> property, int duration,
     ...
     * onDraw() method.
     */
    private Property<SingleBounce, Integer> firstBitmapTopProperty = new Property<SingleBounce, Integer>(
            Integer.class, "firstDrawableTop") {
        @Override
        public Integer get(SingleBounce obj) {
            return obj.firstBitmapTop;
        }

        public void set(SingleBounce obj, Integer value) {
