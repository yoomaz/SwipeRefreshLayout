...
import com.graypn.swiperefreshlayout.R;
...
public class SwipeRefreshLayout extends ViewGroup {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (triggerCondition) {
                    ...
                    // intercept the move action event and pass it to SwipeRefreshLayout#onTouchEvent()
                    return true;
                }
                break;
    ...
    /**
     * 设置最大下拉距离
     * 如果是 0 或者小于 {@link #mRefreshTriggerOffset}，不生效
     */
    ...
    /**
     * 设置下拉状态(没有触发刷新)到初始状态的滑动时间
     * set {@link #mSwipingToRefreshToDefaultScrollingDuration}
     * 单位：milliseconds
     */
    ...
    private boolean onCheckCanRefresh() {
        boolean canChildScrollUp = ViewCompat.canScrollVertically(mTargetView, -1);
        return mRefreshEnabled
                && mHasHeaderView
    ...
    private boolean onCheckCanLoadMore() {
        boolean canChildScrollDown = ViewCompat.canScrollVertically(mTargetView, 1);
    ...
    RefreshCallback mRefreshCallback = new RefreshCallback() {
        ...
        public void onPrepare() {
            if (mHeaderView != null
                    && mHeaderView instanceof SwipeTrigger
